...
from metrics.ti import get_tempo_decorrido_base, filtrar_tempo_decorrido
...
def render():
    ...
    # --- CÁLCULO DE MEDIDAS ---
    df_filtrado['Diferenca_dias_corridos'] = (df_filtrado['Fechado_em'] - df_filtrado['Criado_em']).dt.days
    df_filtrado['Atencao'] = np.where(df_filtrado['Diferenca_dias_corridos'] > 30, "VERIFICAR", "Ok")
