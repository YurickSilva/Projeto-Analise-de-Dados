...
from metrics.ti import filtrar_tickets_abertos, get_tickets_abertos_base, kpi_contagem_coluna
...
def render():
    ...
    with col_principal:
        total_abertos_periodo = kpi_contagem_coluna(df, col="Situacao") if "Situacao" in df.columns else len(df)
