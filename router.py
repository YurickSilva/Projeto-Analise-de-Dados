...
from workspaces.TI_Global import Atendimentos,Clientes,Tempo_Decorrido, Tickets_Abertos, Tickets_Geral, Tickets_Tecnicos

# Roteia o menu selecionado para o código da página correta.
